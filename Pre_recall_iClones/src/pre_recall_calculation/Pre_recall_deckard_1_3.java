...
public class Pre_recall_deckard_1_3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            clone_results_table="deckard_1_3_result";
            ...
            while ((st2 = br2.readLine()) != null) {
                ...
                qr_insert = "INSERT INTO `pre_recall_deckard_1_3` (`change_id`, `change_detect`, `change_total`, `clone_used`, `clone_pr_total`) "
                        ...
                        +" '"+chng_detect+"', '"+(total_change-1)+"', '"+used_clone+"', '"+total_clone+"')";
