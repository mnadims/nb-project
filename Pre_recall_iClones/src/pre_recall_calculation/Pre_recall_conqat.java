...
public class Pre_recall_conqat {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            clone_results_table="iclones_result_rr";
            ...
            while ((st2 = br2.readLine()) != null) {
                ...
                qr_insert = "INSERT INTO `pre_recall_iclones_rr` (`change_id`, `version`, `change_detect`, `change_total`, `clone_used`, `clone_pr_total`) "
