...
public class Pre_recall_nicad {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            cleaned_nicad = new File("data_files/monoosc_changes.txt");
            clone_results_table="nicad_result";
            ...
            while ((st2 = br2.readLine()) != null) {
                ...
                qr_insert = "INSERT INTO `pre_recall_nicad` (`change_id`, `change_detect`, `change_total`, `clone_used`, `clone_pr_total`) "
