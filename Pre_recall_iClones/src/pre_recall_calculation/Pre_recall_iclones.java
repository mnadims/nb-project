...
public class Pre_recall_iclones {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
             ...
             * ****************************************************************
             */
            File cleaned_iclones;
            BufferedReader br2 = null;
            Store_change[] stored_change=new Store_change[1000];
            String st2, qr_detected, qr_actual,qr_change_count, pr_filename,cur_filename, qr_insert, clone_results_table;
            String[] splited1;
            ...
            cleaned_iclones = new File("data_files/"+schema+"_changes.txt");
            clone_results_table="iclones_result";
            br2 = new BufferedReader(new FileReader(cleaned_iclones));
            ...
            while ((st2 = br2.readLine()) != null) {
                ...
                /*query="SELECT `CloneClass` FROM `iclones_result` WHERE "
                        +"`version`="+splited1[0]+" AND `file_name`='"+splited1[1]+"' AND "
                        +" ((`endline`>="+b1+" AND `endline`<="+e1+") OR (`startline`>="+b1+" AND `startline`<="+e1+") "
                        +" OR (`startline`<"+b1+" AND `endline`>"+e1+"))";
                ...
                */
                ...
                qr_insert = "INSERT INTO `pre_recall_iclones` (`change_id`, `version`, `change_detect`, `change_total`, `clone_used`, `clone_pr_total`) "
