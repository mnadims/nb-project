...
public class Pre_recall_simcad {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            clone_results_table="simcad_result_rr";
            ...
            while ((st2 = br2.readLine()) != null) {
                ...
                qr_insert = "INSERT INTO `pre_recall_simcad_rr` (`change_id`, `version`, `change_detect`, `change_total`, `clone_used`, `clone_pr_total`) "
